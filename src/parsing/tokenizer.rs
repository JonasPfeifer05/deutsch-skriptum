...
use crate::parsing::tokenizer::Literals::{FloatLiteral, IntegerLiteral, StringLiteral, TextLiteral};
...
pub fn tokenize(script: String) -> Result<Vec<Token>, String> {
    ...
    let types_regex: Regex = Regex::new("^(wahrheitswert|ganzzahl|gleitkommazahl|text)").unwrap();
